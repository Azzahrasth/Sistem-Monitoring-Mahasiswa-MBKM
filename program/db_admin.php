...
$sudah_lolos = mysqli_query($conn, "SELECT COUNT(status_lolos) as sudah_lolos FROM mengikuti WHERE status_lolos = 'Sudah Lolos'");
$belum_lolos = mysqli_query($conn, "SELECT COUNT(status_lolos) as belum_lolos FROM mengikuti WHERE status_lolos = 'Belum Lolos'");
$belum_dikonfirmasi = mysqli_query($conn, "SELECT COUNT(status_lolos) as belum_dikonfirmasi FROM mengikuti WHERE status_lolos = 'Belum Dikonfirmasi'");
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="db_admin.php" class="nav-item nav-link active"><i
                            class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="bl_admin.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Bukti Lolos</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="identitas-mhs">
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-white rounded d-flex align-items-center justify-content-around p-4">
                                <i class="fas fa-minus-circle fa-3x text-primary"></i>
                                <div class="ms-3">
                                    <?php
                                    $row = mysqli_fetch_assoc($belum_lolos);
                                    ?>
                                    <p class="mb-2">BELUM LULUS</p>
                                    <h6 class="mb-0"><?= $row['belum_lolos'] ?></h6>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-white rounded d-flex align-items-center justify-content-around p-4">
                                ...
                                <div class="ms-3">
                                    <?php
                                    $row = mysqli_fetch_assoc($belum_dikonfirmasi);
                                    ?>
                                    <p class="mb-0">BELUM DIKONFIRMASI</p>
                                    <h6 class="mb-0"><?= $row['belum_dikonfirmasi'] ?></h6>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-white rounded d-flex align-items-center justify-content-around p-4">
                                ...
                                <div class="ms-3">
                                    <?php
                                    $row = mysqli_fetch_assoc($sudah_lolos);
                                    ?>
                                    <p class="mb-2">SUDAH LULUS</p>
                                    <h6 class="mb-0"><?= $row['sudah_lolos'] ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
