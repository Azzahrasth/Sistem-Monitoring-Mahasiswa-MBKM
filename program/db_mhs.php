...
$mhs = mysqli_query($conn, "SELECT nim, nama_mhs, semester FROM mhs WHERE id_mhs = '$id'");
$dosen = mysqli_query($conn, "SELECT nim, nama_mhs, semester, nama_dosen FROM mhs JOIN pm ON mhs.id_pm = pm.id_pm JOIN dosen ON pm.id_dosen = dosen.id_dosen WHERE mhs.id_mhs = '$id'");
$program = mysqli_query($conn, "SELECT nama_program, status_lolos FROM mhs JOIN mengikuti ON mhs.id_mhs = mengikuti.id_mhs JOIN program ON program.id_program = mengikuti.id_program WHERE mhs.id_mhs = '$id'");
$belum_diacc = mysqli_query($conn, "SELECT SUM(sks) as belum_diacc FROM mata_kuliah JOIN konversi_mk ON mata_kuliah.id_matkul = konversi_mk.id_matkul JOIN mhs ON mhs.id_mhs = konversi_mk.id_mhs WHERE mhs.id_mhs = '$id' AND konversi_mk.status_acc = 'Belum diacc'");
$sudah_diacc = mysqli_query($conn, "SELECT SUM(sks) as sudah_diacc FROM mata_kuliah JOIN konversi_mk ON mata_kuliah.id_matkul = konversi_mk.id_matkul JOIN mhs ON mhs.id_mhs = konversi_mk.id_mhs WHERE mhs.id_mhs = '$id' AND konversi_mk.status_acc = 'Sudah diacc'");
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="db_mhs.php" class="nav-item nav-link active"><i
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-around p-4">
                            ...
                            <div class="ms-3">
                                ...
                                $row = mysqli_fetch_assoc($belum_diacc);

                                ?>
                                <span>
                                    <p class="mb-2">SKS MK<br>Pending</p>
                                </span>
                                <h6 class="mb-0">
                                    <?php
                                    if ($row['belum_diacc'] != "") {
                                        echo $row['belum_diacc'];
                                    } else {
                                        echo "0";
                                    }
                                    ?>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-around p-4">
                            ...
                            <div class="ms-3">
                                ...
                                $row = mysqli_fetch_assoc($sudah_diacc);

                                ?>
                                <p class="mb-2">SKS MK<br>Valid</p>
                                <h6 class="mb-0">
                                    <?php
                                    if ($row['sudah_diacc'] != "") {
                                        echo $row['sudah_diacc'];
                                    } else {
                                        echo "0";
                                    }
                                    ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="identitas-mhs">
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-white rounded d-flex align-items-center justify-content-around p-4">
                                <div class="ms-3">
                                    ...
                                    <div class="i-mhs">
                                        <h6 class="mb-0 text-left"><?= $row['nim'] ?></h6>
                                        <h6 class="mb-0 text-left"><?= $row['nama_mhs'] ?></h6>
                                        <h6 class="mb-0 text-left">Semester <?= $row['semester'] ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-white rounded d-flex align-items-center justify-content-around p-4">
                                ...
                                <div class="ms-3">
                                    ...
                                    ?>
                                    <p class="mb-2">Dosen Pembimbing</p>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-white rounded d-flex align-items-center justify-content-around p-4 text-center">
                                <div class="ms-3">
                                    <?php
