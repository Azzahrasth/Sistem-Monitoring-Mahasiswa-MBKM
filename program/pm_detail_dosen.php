                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="mb-4 judul-tabel">
                                <h6>Tabel Mata Kuliah yang Dikonversi</h6>
                                <a href="pm_dosen.php"><i class="far fa-times-circle"></i></a>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $nomor = 1;
                                            $id_mhs = $_GET['key'];
                                            $mata_kuliah = mysqli_query($conn, "SELECT * FROM mata_kuliah JOIN konversi_mk ON mata_kuliah.id_matkul = konversi_mk.id_matkul JOIN mhs ON mhs.id_mhs = konversi_mk.id_mhs WHERE konversi_mk.id_mhs = '$id_mhs'");
