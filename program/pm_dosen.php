<?php
    ...
    {
        echo "<script>
                alert('Anda Bukan Pembimbing MBKM!');
                window.location = 'db_dosen.php';
            </script>";
    }
    ...
    $mahasiswa = mysqli_query($conn, "SELECT * FROM mhs JOIN mengikuti ON mhs.id_mhs = mengikuti.id_mhs JOIN program ON program.id_program = mengikuti.id_program WHERE mhs.id_pm = '$pm'");
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="pm_dosen.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>PM</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Tabel Mahasiswa yang Dibimbing</h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $result["jumlah_sks"] ?></td>
                                            <td><a href="pm_detail_dosen.php?key=<?= $result['id_mhs'] ?>">Detail</a></td>
                                        </tr>
                                        <?php
