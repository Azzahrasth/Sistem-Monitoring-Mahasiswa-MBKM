...
// Nampilin nama Mahasiswa di sidebar
...
if(isset($_POST['submit']))
{
    ...
    move_uploaded_file($tmpName, 'pendaftaran/' . $namaFile);

    mysqli_query($conn, "INSERT INTO mengikuti VALUES('', '$id_program', '$id', '', 'Belum Lolos', '$namaFile', 'NULL')");
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <h6 class="mb-2">Berkas Pendaftaran</h6>
                            <div class="mb-2">
